...
class DailyTasks(commands.Cog):
    ...
    async def send_daily_quote(self):
        ...
        if channel:
            quote = random.choice(self.imperial_quotes)
            
            embed = discord.Embed(
                title="⚙️ Thought of the Day",
                description=f"*{quote}*",
                color=discord.Color.from_rgb(200, 160, 40) # Αυτοκρατορικό Χρυσό
            )
            embed.set_footer(text="Thought generated by the Adeptus Mechanicus")
